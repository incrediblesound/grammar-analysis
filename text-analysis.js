var count =  function (txt, rank) {
    ...
    if(rank) {return ranking(wordFreq);}
    else {return wordFreq}
 };

var ranking = function(list) {
  var ranks = [{word: null, count: 0},{word: null, count: 0},{word: null, count: 0}];
...
var gramAnalysis = function(text) {
  ...
  return ( { grammarSchema: grammar, grammarEval: Eval } ); 
};
